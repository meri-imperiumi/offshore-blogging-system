...
const { findImagesFromMarkdown } = require("../plugin/index.js");
...
describe("findImagesFromMarkdown", () => {
  ...
  it("should find a single image with alt text", () => {
    const body =
      "Here is a photo: ![Afternoon cruise](../2021/8ac846b5893d81618f57d0ab08744b0a.jpg)";
    const images = findImagesFromMarkdown(body, "2021-08-24", "/home/pi/log");
    assert.strictEqual(images.length, 1);
    assert.strictEqual(images[0].alt, "Afternoon cruise");
    assert.strictEqual(
      images[0].path,
      "../2021/8ac846b5893d81618f57d0ab08744b0a.jpg",
    );
    assert.strictEqual(
      images[0].resolvedPath,
      "/home/pi/log/2021/8ac846b5893d81618f57d0ab08744b0a.jpg",
    );
  });
...
![Second photo](../2021/def456.jpg)
  ...
  it("should handle images with nested directory paths", () => {
    ...
    assert.strictEqual(
      images[0].resolvedPath,
      "/home/pi/log/2021/subdir/nested.jpg",
    );
  });
  ...
  it("should handle images with parentheses in filename", () => {
    ...
    assert.strictEqual(
      images[0].resolvedPath,
      "/home/pi/log/2026/20260716_113823(0).jpg",
    );
  });
});
