 ...
 *
 * The three fields are joined with \x1f (ASCII unit separator) before
 * compression so decompressText can split them back out.
 *
 * @param {string} title
 * @param {string} date
 * @param {string} body
...
/**
 * Decompress a blog post blob back into { title, date, body }.
 *
 * @param {Buffer} compressed
 * @param {Buffer} [dictionary=SAIL_DICT]
 * @returns {{ title: string, date: string, body: string }}
 */
